def create_graph(graph):
    ...
    graph.add_edge('LD', 'TA',dist=1, bi=True)
    ...
    graph.add_edge('LG', 'TA',dist=1, bi=True)
    graph.add_edge('TA', 'LG',dist=1, bi=True)
    ...
    graph.add_edge('BN', 'RK',dist=1, bi=True)
    ...
    graph.add_edge('RH', 'BN',dist=1, bi=True)
    graph.add_edge('BN', 'RH',dist=1, bi=True)
    ...
    graph.add_edge('RA', 'TK',dist=1, bi=True)
    ...
    graph.add_edge('TH', 'RA',dist=1, bi=True)
    graph.add_edge('RA', 'TH',dist=1, bi=True)
    ...
    graph.add_edge('BD', 'LN',dist=1, bi=True)
    ...
    graph.add_edge('BG', 'LN',dist=1, bi=True)
    graph.add_edge('LN', 'BG',dist=1, bi=True)
